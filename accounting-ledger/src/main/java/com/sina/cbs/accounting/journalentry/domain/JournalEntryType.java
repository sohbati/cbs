...
public enum JournalEntryType {
    ...
    CREDIT("CR", "journalEntryType.credit"), DEBIT("DR", "journalEntrytType.debit");

    private final String value;
    private final String code;

    JournalEntryType(final String value, final String code) {
        this.value = value;
        this.code = code;
    }
    ...
    private static final Map<String, JournalEntryType> intToEnumMap = new HashMap<>();
